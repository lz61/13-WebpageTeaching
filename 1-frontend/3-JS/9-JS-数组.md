...
```
var x = new Array(2); // 括号中的参数2可以为任意非负整数,此时x中的值都是undefined(没有初始化的数组内部值是undefined)
var x = [1,2,3,4,5]; // 直接初始化x
```

定义: 数组元素个数=数组长度=数组大小.

注1: 数组的长度必须为非负整数,且数组长度在初始化时已然确定.
...
```
[11,23,31,46,5123,123,412424,1321,321,3123,31213,2131,21432,4312,412,3313]
```
...
```
var x = [11, 23, 31, 46, 5123, 123, 412424, 1321, 321, 3123, 31213, 2131, 21432, 4312, 412, 3313];
var n = x.length;
for(var i=0;i<n;i++){
    console.log(x[i]);
}
